...
export const ENEMIES: Enemy[] = [
  // =================== HUMANÓIDES ===================
  { id: 'bandit', name: 'Bandido', type: 'Humanoide', role: 'Ataque', icon: '' },
  { id: 'guard', name: 'Guarda', type: 'Humanoide', role: 'Tanque', icon: '' },
  { id: 'archer', name: 'Arqueiro', type: 'Humanoide', role: 'Ataque', icon: '' },
  { id: 'swordsman', name: 'Espadachim', type: 'Humanoide', role: 'Ataque', icon: '' },
  ...
  // =================== ARANHAS ===================
  { id: 'spider', name: 'Aranha', type: 'Monstro', role: 'Controle', icon: '' },
  { id: 'giant_spider', name: 'Aranha Gigante', type: 'Elite', role: 'Controle', icon: '' },
  ...
  { id: 'frog_man', name: 'Homem-sapo', type: 'Humanoide', role: 'Ataque', icon: '' },
  { id: 'frog_priest', name: 'Sacerdote do Sapo', type: 'Humanoide', role: 'Suporte', icon: '' },
  { id: 'temple_guardian', name: 'Guardião do Templo', type: 'Elite', role: 'Tanque', icon: '' },
